...
noticeText:SetText(
    ...
    "탤런트로 쿨이 줄어든 경우 파티원은 반영되지 않을 수 있습니다.\n\n" ..
    "|cffffff00[ 탤런트 쿨감이 반영 안 될 수 있는 스킬 ]|r\n" ..
    "|cffaaaaaa드루이드|r\n" ..
    "• 평온: 내면의 평화 탤런트 180→150 (-30s)\n" ..
    "• 무쇠 껍질: 무쇠껍질 연마 탤런트 90→70 (-20s)\n" ..
    "|cffaaaaaa사제|r\n" ..
    "• 천상의 찬가: 대천사의 점증 탤런트 180→120 (-60s)\n" ..
    "• 수호 영혼: 수호 천사 탤런트 — 대상을 살리지 못하고\n" ..
    "  만료 시 남은 쿨이 60s로 감소 |cffff6600(조건부, 추적 불가)|r\n" ..
    "• 고통 억제: 약자의 보호자 탤런트 — 충전 1회 추가 +\n" ..
    "  신의 권능: 보호막 사용 시마다 3s 감소 |cffff6600(동적 감소, 추적 불가)|r\n" ..
    "|cffaaaaaa수도사|r\n" ..
    "• 재활 / 회복: 고양된 영혼 탤런트 150→120 (-30s)\n" ..
    "• 기의 고치: 번데기 탤런트 120→75 (-45s)\n" ..
    "|cffaaaaaa기원사|r\n" ..
    "• 되돌리기: 시간의 기술자 탤런트 240→180 (-60s)\n" ..
    "|cffaaaaaa주술사|r\n" ..
    "• 승천 / 치유의 해일 토템: 최초의 승천자 탤런트 180→120 (-60s)\n\n" ..
    "|cffffff00[ 언제 정확한가 ]|r\n" ..
    "• 본인 스킬: 탤런트 적용 실제 CD 자동 반영\n" ..
    "• 파티원 스킬: 애드온 설치 후 1회 사용 시점부터 갱신\n" ..
    "• 애드온 미설치 파티원: 전투 로그 감지, 기본 CD 사용"
)
